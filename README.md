...
`тип`* | max | Тип срабатывания брейкпоинта. max - Desktop First, min - Mobile First. *При использовании `min` в некоторых ситуациях может возникнуть проблема порядком вывода элементов.
