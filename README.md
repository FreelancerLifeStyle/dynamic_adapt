...
`когда` | 769 | Брейкпоинт при котором перемещать объект.
...
`тип` | min | Тип срабатывания брейкпоинта. max - Desktop First, min - Mobile First.
...
<div data-da="content__column_garden, 992, 2, max" class="content__block">Я Коля</div>
```
